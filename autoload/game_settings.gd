...
const PLAYER_ONE_SPAWN: Vector2 = Vector2(200.0, 480.0)
const PLAYER_TWO_SPAWN: Vector2 = Vector2(1100.0, 480.0)
...
const POINT_TRANSITION_SECONDS: float = 1.0
const ONLINE_KILL_BANNER_SECONDS: float = POINT_TRANSITION_SECONDS
const ONLINE_INTERMISSION_SECONDS: float = 60.0
const ONLINE_LOCKER_COUNTDOWN_SECONDS: float = 3.0
const START_WITH_ALL_ARMOR_ITEMS: bool = false
const START_WITH_ALL_WEAPON_EXTENSIONS: bool = false
const COIN_DAMAGE_STEP: int = 10
const COIN_SURVIVAL_STEP_SECONDS: float = 8.0
const COIN_BLOCK_DAMAGE_STEP: int = 20
const COIN_BLOCK_REWARD: int = 2
const COIN_FIRST_HIT_REWARD: int = 10
const SHOP_MIN_PRICE: int = 8
const SHOP_MAX_PRICE: int = 26
const EXTENSION_MAX_MARK: int = 3
const EXTENSION_MERGE_MK2_COST: int = 12
const EXTENSION_MERGE_MK3_COST: int = 20
const ARMOR_MERGE_MK2_COST: int = EXTENSION_MERGE_MK2_COST
const ARMOR_MERGE_MK3_COST: int = EXTENSION_MERGE_MK3_COST
...
const NETWORK_LOBBY_MODE: String = "friend_invite"
...
const NETWORK_PACKET_READ_LIMIT: int = 24
const NETWORK_STATE_PACKET_READ_LIMIT: int = 64
const NETWORK_PLAYER_STATE_RATE: float = 20.0
const NETWORK_PLAYER_HEARTBEAT_RATE: float = 5.0
const NETWORK_PLAYER_POSITION_EPSILON: float = 1.5
const NETWORK_PLAYER_VELOCITY_EPSILON: float = 8.0
const NETWORK_PLAYER_AIM_EPSILON: float = 3.0
const NETWORK_SHOT_SPAWN_TOLERANCE: float = 180.0
...
const PACKET_STATUS_EFFECT_APPLIED: StringName = &"status_effect_applied"
...
const PLAYER_REMOTE_EXTRAPOLATION_SECONDS: float = 0.055
const PLAYER_REMOTE_SNAP_DISTANCE: float = 180.0
...
const PLAYER_HIT_SHAKE_STRENGTH: float = 3.2
const PLAYER_HIT_SHAKE_TIME: float = 0.10
const PLAYER_DEATH_SHAKE_STRENGTH: float = 4.8
const PLAYER_DEATH_SHAKE_TIME: float = 0.18
const TRAINING_DUMMY_COUNT: int = 1
const TRAINING_DUMMY_SPAWN_OFFSET_X: float = 300.0
const TRAINING_DUMMY_SPAWN_Y: float = 480.0
const PLAYER_RESPAWN_DELAY: float = POINT_TRANSITION_SECONDS
const PLAYER_SPAWN_SHAKE_STRENGTH: float = 1.2
...
const AIRDROP_WARNING_SECONDS: float = 1.8
const AIRDROP_DROP_DELAY_SECONDS: float = 15.0
const AIRDROP_SIREN_INTERVAL: float = 0.46
const AIRDROP_SIREN_PULSES: int = 4
...
const AIRDROP_STATE_RATE: float = 15.0
...
const ARM_SHIELD_ROTATION_OFFSET_DEGREES: float = 0.0
...
const GUN_FIRE_SHAKE_STRENGTH: float = 1.2
const GUN_FIRE_SHAKE_TIME: float = 0.055

const PROJECTILE_MUZZLE_SPEED: float = 1000.0
const PROJECTILE_GRAVITY: float = 2600.0
...
const PROJECTILE_IMPACT_SHAKE_STRENGTH: float = 0.7
