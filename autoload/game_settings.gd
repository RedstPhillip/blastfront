...
const DEBUG_UNLOCK_ALL_ITEMS: bool = true
const DEBUG_UNLOCK_ALL_EXTENSIONS: bool = false
...
const NETWORK_MODE_DEBUG: StringName = &"debug"
...
const DEBUG_DUMMY_COUNT: int = 2
const DEBUG_DUMMY_SPAWN_OFFSET_X: float = 300.0
const DEBUG_DUMMY_SPAWN_Y: float = 116.0
