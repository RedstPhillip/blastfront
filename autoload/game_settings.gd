...
const COIN_FIRST_HIT_REWARD: int = 2
...
const TRAINING_DUMMY_COUNT: int = 2
const TRAINING_DUMMY_SPAWN_OFFSET_X: float = 300.0
const TRAINING_DUMMY_SPAWN_Y: float = 116.0
...
const AIRDROP_WARNING_SECONDS: float = 2.25
...
const GUN_PROJECTILE_GRAVITY: float = 3000.0
...
const PROJECTILE_GRAVITY: float = 3000.0
